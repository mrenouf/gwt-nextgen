...
public final class Geolocation extends JavaScriptObject {
  ...
  public native void getCurrentPosition(PositionHandler handler) /*-{
    this.getCurrentPosition(
      function(position) {
        @com.google.gwt.geolocation.client.Geolocation::firePositionSuccess(Lcom/google/gwt/geolocation/client/PositionHandler;Lcom/google/gwt/geolocation/client/Position;)(handler, position);
      }, 
      function(error) {
        @com.google.gwt.geolocation.client.Geolocation::firePositionError(Lcom/google/gwt/geolocation/client/PositionHandler;Lcom/google/gwt/geolocation/client/PositionError;)(handler, error);
      }
    );
  }-*/;
