...
/**
 * Represents a native open event.
 */
public class OpenEvent extends DomEvent<OpenHandler> {

  /**
   * Event type for open events. Represents the meta-data associated with this
   * event.
   */
  ...
  /**
   * Gets the event type associated with open events.
   * 
