...
public final class Float32Array extends TypedArray {
   ...
   * typed array, then creates a Float32Array referring to the full buffer.
   ...
   * raised.
   *
   * @param length the length of the array in float32 (4 byte) elements
   * @return A new Float32Array instance
   */
  public static native Float32Array create(double length) /*-{
    return new Float32Array(length);
  }-*/;

  /**
   * Create a new ArrayBuffer with enough bytes to hold array.length elements of
   * this typed array, then creates a Float32Array referring to the full
   ...
   */
  public static native Float32Array of(TypedArray array) /*-{
  ...
  public static native Float32Array of(JsArrayNumber array) /*-{
    return new Float32Array(array);
  }-*/;

  /**
   * Create a new Float32Array using the passed ArrayBuffer for its
   * storage, the Float32Array spans the entire ArrayBuffer range.
   * <p>
   ...
   * @return
   */
  public static native Float32Array of(ArrayBuffer buffer) /*-{
    return new Float32Array(buffer, byteOffset);
  }-*/;

  /**
   * Create a new Float32Array object using the passed ArrayBuffer for its
   * storage. The byteOffset indicates the offset in bytes from the start of the
   * ArrayBuffer. The Float32Array extends from the given byteOffset until the end
   * of the ArrayBuffer.
   * <p>
   ...
   */
  public static native Float32Array of(ArrayBuffer buffer, double byteOffset) /*-{
    return new Float32Array(buffer, byteOffset);
  }-*/;
   ...
   * @return a new Typed array instance
   */
  public static native Float32Array of(ArrayBuffer buffer, double byteOffset, double length) /*-{
   ...
   */
  public native final Float32Array subarray(double begin) /*-{
   ...
   * @return A new TypedArray view of the ArrayBuffer store
   */
  public native final Float32Array subarray(double begin, double end) /*-{
