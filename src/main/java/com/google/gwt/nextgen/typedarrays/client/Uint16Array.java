...
public final class Uint16Array extends TypedArray {
   ...
   * typed array, then creates a Uint16Array referring to the full buffer.
   ...
   * raised.
   *
   * @param length the length of the array in uint16 (2 byte) elements
   * @return A new Uint16Array instance
   */
  public static native Uint16Array create(double length) /*-{
    return new Uint16Array(length);
  }-*/;

  /**
   * Create a new ArrayBuffer with enough bytes to hold array.length elements of
   * this typed array, then creates a Uint16Array referring to the full
   ...
   * @return A new Uint16Array for this type
   */
  public static native Uint16Array of(Uint16Array array) /*-{
  ...
  public static native Uint16Array of(JsArrayNumber array) /*-{
    return new Uint16Array(array);
  }-*/;

  /**
   * Create a new Uint16Array object using the passed ArrayBuffer for its
   * storage, the Uint16Array spans the entire ArrayBuffer range.
   * <p>
   ...
   * @return
   */
  public static native Uint16Array of(ArrayBuffer buffer) /*-{
   ...
   * ArrayBuffer. The Uint16Array extends from the given byteOffset until the end
   * of the ArrayBuffer.
   * <p>
   ...
   */
  public static native Uint16Array of(ArrayBuffer buffer, double byteOffset) /*-{
    return new Uint16Array(buffer, byteOffset);
  }-*/;
   ...
   * @param length
   *          the count of elements from the offset that this Uint16Array will
   *          reference
   * @return a new Typed array instance
   */

  public static native Uint16Array of(ArrayBuffer buffer, double byteOffset, double length) /*-{
    return new Uint16Array(buffer, byteOffset, length);
  }-*/;
  /**
   * Get an element in the array
   * @param index The offset to retrieve
   * return value A value in the range [0, 65535]
   */
  ...
  /**
   * Returns a new Uint16Array view of the ArrayBuffer store for this Uint16Array,
   ...
   * @return A new Uint16Array view of the ArrayBuffer store
   */
  public native final Uint16Array subarray(double begin) /*-{
   ...
   * @return A new Uint16Array view of the ArrayBuffer store
   */
  public native final Uint16Array subarray(double begin, double end) /*-{
