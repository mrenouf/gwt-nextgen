 ...
 * the License.
 */
package com.google.gwt.nextgen.media.client;
...
import com.google.gwt.nextgen.media.client.event.AbortEvent;
import com.google.gwt.nextgen.media.client.event.AbortHandler;
import com.google.gwt.nextgen.media.client.event.CanPlayEvent;
import com.google.gwt.nextgen.media.client.event.CanPlayHandler;
import com.google.gwt.nextgen.media.client.event.CanPlayThroughEvent;
import com.google.gwt.nextgen.media.client.event.CanPlayThroughHandler;
import com.google.gwt.nextgen.media.client.event.DurationChangeEvent;
import com.google.gwt.nextgen.media.client.event.DurationChangeHandler;
import com.google.gwt.nextgen.media.client.event.EmptiedEvent;
import com.google.gwt.nextgen.media.client.event.EmptiedHandler;
import com.google.gwt.nextgen.media.client.event.EndedEvent;
import com.google.gwt.nextgen.media.client.event.EndedHandler;
import com.google.gwt.nextgen.media.client.event.ErrorEvent;
import com.google.gwt.nextgen.media.client.event.ErrorHandler;
import com.google.gwt.nextgen.media.client.event.HasAbortHandlers;
import com.google.gwt.nextgen.media.client.event.HasCanPlayHandlers;
import com.google.gwt.nextgen.media.client.event.HasCanPlayThroughHandlers;
import com.google.gwt.nextgen.media.client.event.HasDurationChangeHandlers;
import com.google.gwt.nextgen.media.client.event.HasEmptiedHandlers;
import com.google.gwt.nextgen.media.client.event.HasEndedHandlers;
import com.google.gwt.nextgen.media.client.event.HasErrorHandlers;
import com.google.gwt.nextgen.media.client.event.HasLoadStartHandlers;
import com.google.gwt.nextgen.media.client.event.HasLoadedDataHandlers;
import com.google.gwt.nextgen.media.client.event.HasLoadedMetadataHandlers;
import com.google.gwt.nextgen.media.client.event.HasPauseHandlers;
import com.google.gwt.nextgen.media.client.event.HasPlayHandlers;
import com.google.gwt.nextgen.media.client.event.HasPlayingHandlers;
import com.google.gwt.nextgen.media.client.event.HasProgressHandlers;
import com.google.gwt.nextgen.media.client.event.HasRateChangeHandlers;
import com.google.gwt.nextgen.media.client.event.HasSeekedHandlers;
import com.google.gwt.nextgen.media.client.event.HasSeekingHandlers;
import com.google.gwt.nextgen.media.client.event.HasStalledHandlers;
import com.google.gwt.nextgen.media.client.event.HasSuspendHandlers;
import com.google.gwt.nextgen.media.client.event.HasTimeUpdateHandlers;
import com.google.gwt.nextgen.media.client.event.HasVolumeChangeHandlers;
import com.google.gwt.nextgen.media.client.event.HasWaitingHandlers;
import com.google.gwt.nextgen.media.client.event.LoadStartEvent;
import com.google.gwt.nextgen.media.client.event.LoadStartHandler;
import com.google.gwt.nextgen.media.client.event.LoadedDataEvent;
import com.google.gwt.nextgen.media.client.event.LoadedDataHandler;
import com.google.gwt.nextgen.media.client.event.LoadedMetadataEvent;
import com.google.gwt.nextgen.media.client.event.LoadedMetadataHandler;
import com.google.gwt.nextgen.media.client.event.PauseEvent;
import com.google.gwt.nextgen.media.client.event.PauseHandler;
import com.google.gwt.nextgen.media.client.event.PlayEvent;
import com.google.gwt.nextgen.media.client.event.PlayHandler;
import com.google.gwt.nextgen.media.client.event.PlayingEvent;
import com.google.gwt.nextgen.media.client.event.PlayingHandler;
import com.google.gwt.nextgen.media.client.event.ProgressEvent;
import com.google.gwt.nextgen.media.client.event.ProgressHandler;
import com.google.gwt.nextgen.media.client.event.RateChangeEvent;
import com.google.gwt.nextgen.media.client.event.RateChangeHandler;
import com.google.gwt.nextgen.media.client.event.SeekedEvent;
import com.google.gwt.nextgen.media.client.event.SeekedHandler;
import com.google.gwt.nextgen.media.client.event.SeekingEvent;
import com.google.gwt.nextgen.media.client.event.SeekingHandler;
import com.google.gwt.nextgen.media.client.event.StalledEvent;
import com.google.gwt.nextgen.media.client.event.StalledHandler;
import com.google.gwt.nextgen.media.client.event.SuspendEvent;
import com.google.gwt.nextgen.media.client.event.SuspendHandler;
import com.google.gwt.nextgen.media.client.event.TimeUpdateEvent;
import com.google.gwt.nextgen.media.client.event.TimeUpdateHandler;
import com.google.gwt.nextgen.media.client.event.VolumeChangeEvent;
import com.google.gwt.nextgen.media.client.event.VolumeChangeHandler;
import com.google.gwt.nextgen.media.client.event.WaitingEvent;
import com.google.gwt.nextgen.media.client.event.WaitingHandler;
...
public abstract class Media extends Widget implements HasAbortHandlers,
  ...
  native void nativeSinkMediaEvents(Element elem, int bits) /*-{
    ...
    if (chMask & 0x00001) if (bits & 0x00001)
        elem.addEventListener('abort', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('abort', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00002) if (bits & 0x00002)
        elem.addEventListener('canplay', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('canplay', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00004) if (bits & 0x00004)
        elem.addEventListener('canplaythrough', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('canplaythrough', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00008) if (bits & 0x00008)
        elem.addEventListener('durationchange', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('durationchange', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00010) if (bits & 0x00010)
        elem.addEventListener('emptied', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('emptied', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00020) if (bits & 0x00020)
        elem.addEventListener('ended', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('ended', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00040) if (bits & 0x00040)
        elem.addEventListener('error', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('error', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00080) if (bits & 0x00080)
        elem.addEventListener('loadstart', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('loadstart', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00100) if (bits & 0x00100)
        elem.addEventListener('loadeddata', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('loadeddata', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00200) if (bits & 0x00200)
        elem.addEventListener('loadedmetadata', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('loadedmetadata', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00400) if (bits & 0x00400) 
        elem.addEventListener('pause', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('pause', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x00800) if (bits & 0x00800) 
        elem.addEventListener('play', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('play', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x01000) if (bits & 0x01000) 
        elem.addEventListener('playing', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('playing', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x02000) if (bits & 0x02000) 
        elem.addEventListener('progress', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('progress', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x04000) if (bits & 0x04000) 
        elem.addEventListener('ratechange', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('ratechange', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x08000) if (bits & 0x08000)
        elem.addEventListener('seeked', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('seeked', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x10000) if (bits & 0x10000)
        elem.addEventListener('seeking', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('seeking', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x20000) if (bits & 0x20000)
        elem.addEventListener('stalled', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('stalled', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false); 
    if (chMask & 0x40000) if (bits & 0x40000)
        elem.addEventListener('suspend', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('suspend', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x80000) if (bits & 0x80000)
        elem.addEventListener('timeupdate', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('timeupdate', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x100000) if (bits & 0x100000)
        elem.addEventListener('volumechange', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('volumechange', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
    if (chMask & 0x200000) if (bits & 0x200000)
        elem.addEventListener('waiting', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false)
        else elem.removeEventListener('waiting', @com.google.gwt.nextgen.media.client.Media::dispatchEvent, false);
  }-*/;
  ...
  private static native void initMediaEvents() /*-{
    @com.google.gwt.nextgen.media.client.Media::dispatchEvent = function(evt) {
      var curElem = evt.target;
      var listener = curElem.__listener;
      if (listener) {
          @com.google.gwt.nextgen.media.client.Media::dispatchMediaEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/user/client/EventListener;)(evt, listener);
      }
    }
  }-*/;
